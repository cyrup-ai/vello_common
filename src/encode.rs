...
use super::blurred_rounded_rect::BlurredRoundedRectangle;
use super::color::palette::css::BLACK;
use super::color::{ColorSpaceTag, HueDirection, Srgb, gradient};
use super::kurbo::{Affine, Point, Vec2};
use super::math::compute_erf7;
use super::peniko::{ColorStop, Extend, Gradient, GradientKind, ImageQuality};
use super::pixmap::Pixmap;
use crate::vello_api::paint::{Image, IndexedPaint, Paint, PremulColor};
...
fn encode_stops(
    ...
    struct EncodedColorStop {
        offset: f32,
        color: crate::vello_api::color::PremulColor<Srgb>,
    }
...
mod tests {
    ...
    use super::super::color::DynamicColor;
    use super::super::color::palette::css::{BLACK, BLUE, GREEN};
    use super::super::kurbo::Point;
    use super::super::peniko::{ColorStop, ColorStops, GradientKind};
    use super::{EncodeExt, Gradient};
    use crate::vello_api::kurbo::Affine;
